...
var grammar = {
    ...
    {"name": "member", "symbols": ["nb"], "postprocess": ignore},
    ...
    {"name": "parentesis", "symbols": [{"literal":"("}, "exp", {"literal":")"}], "postprocess": parseParentesis},
    ...
    {"name": "op", "symbols": [(lexer.has("op") ? {type: "op"} : op)], "postprocess": ignore},
    {"name": "nb", "symbols": [(lexer.has("nb") ? {type: "nb"} : nb)], "postprocess": ignore},
